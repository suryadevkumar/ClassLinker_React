            ...
            <div className="flex justify-center items-center py-36 bg-gray-100">
                <div className="container w-[400px] mb-3">
                    <div className="login-form bg-white p-8 rounded-lg shadow-lg">
                        <h2 className="text-2xl font-bold mb-4 text-center">{login_type} Login</h2>
                        <form>
                            ...
                            <div className="flex justify-between items-center mb-4">
                                {login_type=="Admin" ? <Link to="/instituteLogin" class="text-blue-500 hover:underline">Institute Login</Link>:
                                <div class="flex items-center">
                                <input type="checkbox" class="mr-2"/>
                                <label>Remember me</label>
                            </div>}
                                <a href="reset-password.html" className="text-blue-500 hover:underline">Forgot password?</a>
                            </div>
                            <button
                                type="submit"
                                onClick={UserLogin}
                            ...
                            <Link to="/studentSignup" className="text-blue-500 hover:underline">Sign up</Link>
                            </p>
                        </form>
                    </div>
                </div>
